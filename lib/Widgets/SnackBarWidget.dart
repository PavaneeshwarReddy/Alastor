...
class CustomSnackBar extends StatelessWidget {
  ...
  String msg;
  String subtitle;
  CustomSnackBar(this.bubblePath, this.msgbubblePath, this.backgroundColor,
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Container(
            margin: EdgeInsets.only(left: 150.w, top: 10.h),
            child: Column(
              ...
              children: [
                Text(
                  msg,
                  style:
                      GoogleFonts.inriaSans(fontSize: 28, color: Colors.white),
                ),
                Text(subtitle,
